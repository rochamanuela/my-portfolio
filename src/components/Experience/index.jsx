    ...
    <div className="experience">
      <div className="experience-section-title">
        <div className="child">
          <h1>Experiência</h1>
          <hr />
          <p style={{ paddingLeft: '20%' }}>Desenvolvedora de Software e UI/UX Designer | Robert 
            Bosch <br />Campinas, Brasil | Janeiro de 2023 - Presente</p>
        </div>
        <div className="child">
          <p style={{ paddingRight: '14%' }}>Na Bosch foi onde tive e tenho a oportunidade de 
            aprender, evoluir e crescer na minha área. Durante este período participei de diversos 
            projetos, tais como:</p>
        </div>
      </div>
      <section className="experience-content">
        <div className="text" style={{ paddingLeft: '10%' }}>
